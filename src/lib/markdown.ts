...
export const markdownClass =
  ...
  '[&_code]:font-mono [&_code]:text-[12px] [&_code]:bg-background/60 [&_code]:border [&_code]:border-border [&_code]:rounded [&_code]:px-1 [&_code]:py-0.5 ' +
  ...
  '[&_th]:bg-muted [&_th]:text-foreground [&_th]:border [&_th]:border-border [&_th]:px-2 [&_th]:py-1 [&_th]:font-medium [&_th]:text-left ' +
